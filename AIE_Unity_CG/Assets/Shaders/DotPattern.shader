    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                // sample the pattern texture to apply to screen space

                fixed4 pattern = tex2D(_PatternTex, wcoord);

                // Use step values with step functions to choose between the highlight, base and shadow colors
